...
char ADRESS_DBK[2] = {0x00, 0x00};	// Адрес ДБК
char DIEN_DBK[2] = {0x00, 0x00};	// Служебное поле ДБК
char DIAG_DBK = 0x00;	// Поле диагностики
char INFO_DBK[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};	// Поле данных
char DATA_DBK[4] = {0x00, 0x00, 0x00, 0x00};	// Метка времени
char CONTROL_DBK[2]	= {0x00, 0x00};	// Контрольное поле
#define LEN_RS 18	// Длина пакета данных
